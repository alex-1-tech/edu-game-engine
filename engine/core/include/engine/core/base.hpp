...
#define EGE_FORCE_INLINE inline __attribute__((always_inline)) ///< Force inlining (GCC/Clang)
#else
...
#endif
#else
#define EGE_API __attribute__((visibility("default"))) ///< Default visibility on non-Windows
#endif
